...
namespace LeitorNfe.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDProduto,nItem,cProduto,nProduto,qtdProduto,vUnitario,vTotalProduto")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDProduto,nItem,cProduto,nProduto,qtdProduto,vUnitario,vTotalProduto")] Produto produto)
        {
