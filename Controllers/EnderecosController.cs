...
namespace LeitorNfe.Controllers
{
    public class EnderecosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDEndereco,logadouro,numero,bairro,municipio,uf,cep")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDEndereco,logadouro,numero,bairro,municipio,uf,cep")] Endereco endereco)
        {
