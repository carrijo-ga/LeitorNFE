...
namespace LeitorNfe.Controllers
{
    public class NotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDNota,nNota,dEmissao,IDEmitente,IDDestinatario,nPedidoCompra,IDProduto,cAcesso,comentario,totalNota")] Nota nota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDNota,nNota,dEmissao,IDEmitente,IDDestinatario,nPedidoCompra,IDProduto,cAcesso,comentario,totalNota")] Nota nota)
        {
            if (id != nota.IDNota)
            {
                return NotFound();
